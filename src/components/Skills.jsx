import { FaLaptopCode, FaServer, FaExpand, FaDatabase } from "react-icons/fa";
      ...
      <div className="px-4 md:px-20">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-300 text-sm md:text-xl text-left">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="bg-gray-800 p-3 rounded-md ">
            <FaDatabase className="text-green-300 text-3xl md:text-5xl" />
          </div>
